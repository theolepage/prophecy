/*! \file cuda_memory.cuh
    ...
    To make a safe call, use our wrapper, if it's not in the list you can either:
     ...
     - Directly use 'cuda_safe_call' in your code

    The behavior in case of error can be found in the cuda_error_checking.cuh file
    ...
    (you can again modify this behavior if you wish in the cuda_error_checking.cuh file)
*/
